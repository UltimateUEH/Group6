    ...
    public partial class v0 : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK__Tenant__D6F29F3E261E8E5C", x => x.tenant_id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK__Company__3E2672352E176FF1", x => x.company_id);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK__Product__47027DF5915A60F7", x => x.product_id);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK__Account__46A222CD6E4C817C", x => x.account_id);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK__Customer__CD65CB8551EFA01C", x => x.customer_id);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK__Invoice__F58DFD498BC93769", x => x.invoice_id);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK__InvoiceD__B1FDDA9612106786", x => new { x.invoice_id, x.product_id });
                    table.ForeignKey(
                        name: "FK__InvoiceDe__invoi__5CD6CB2B",
                        column: x => x.invoice_id,
                        principalTable: "Invoice",
                        principalColumn: "invoice_id");
                    table.ForeignKey(
                        name: "FK__InvoiceDe__produ__5DCAEF64",
                        column: x => x.product_id,
                        principalTable: "Product",
                        principalColumn: "product_id");
                    table.ForeignKey(
                        name: "FK__InvoiceDe__tenan__5EBF139D",
                        column: x => x.tenant_id,
                        principalTable: "Tenant",
                        principalColumn: "tenant_id");
                });
